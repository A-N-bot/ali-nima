...
--- Channel:https://telegram.me/ch_anonymou3TG
...
local function create_group(msg)
    ...
    if not is_admin(msg) then
        return "This service is private for SUDO 🍷 @anonymou3nk🍷"
    end
...
local function lock_group_photo(msg, data)
    if not is_momod(msg) then
        return "❗️You are NOT moderator❗️"
    end
...
local function show_group_settings(msg, data)
    ...
    local text = "⚙Group Settings⚙:\n_~_~_~_~انـــونــیــمـــوس_~_~_~_~\n⭕️ Lock Group Name🅰 : "..settings.lock_name.."\n⭕️ Lock Group Photo🅰 : "..settings.lock_photo.."\n⭕️ Lock Group Member🅰 : "..settings.lock_member.."\n⭕️ Anti Spam System🅰 : on\n⭕️ Anti Spam Mod🅰 : kick\n⭕️ Anti Spam Action#🅰 : 10\n⭕️ Group Status🅰 : active\n⭕️ Group Model🅰 : free\n⭕️ Group Mod🅰 : 2\n⭕️ Supportion🅰 : yes\n⭕️ Bot Version🅰 : 1.3.8"
    return text
end
